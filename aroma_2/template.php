       ...
       <div class="container">
         ...
         <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
           <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
             ...
             <li class="nav-item submenu dropdown">
               ...
               <ul class="dropdown-menu">
                 <li class="nav-item"><a class="nav-link" href="category.html">Категории товаров</a></li>
                 <li class="nav-item"><a class="nav-link" href="single-product.html">Товары</a></li>
                 <li class="nav-item"><a class="nav-link" href="checkout.html">Оплата</a></li>
           ...
           <ul class="nav-shop">
             ...
             <li class="nav-item"><a class="button button-header" href="/reg">Вход на сайт</a></li>
           </ul>
         </div>
       </div>
     </nav>
